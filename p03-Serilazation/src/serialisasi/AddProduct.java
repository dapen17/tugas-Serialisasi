...
public class AddProduct extends javax.swing.JDialog {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtShoeSize, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtNamaProduk, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                            .addComponent(txtId))))
                .addGap(15, 15, 15))
        );
   ...
   String color = txtColor.getText(); // Mendapatkan warna dari field
   String sizeStr = txtShoeSize.getText();  // Mendapatkan ukuran sepatu dari field
   int row = tabelItem.getRowCount();
   
    if (id_produk.isEmpty() || nama_produk.isEmpty() || color.isEmpty() || sizeStr.isEmpty()) {
        ...
        MainForm.product.setColor(color); // Mengatur warna
        MainForm.product.setShoeSize(Double.parseDouble(sizeStr)); // Mengatur ukuran sepatu
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        String txt_item_name = txtNamaItem.getText(); // Perbaikan penulisan nama variabel
        String txt_item_price = txtHargaItem.getText();
        Object[] item = {txt_item_name, txt_item_price}; // Perbaikan penulisan tanda kurung kurawal
        model.addRow(item);
